...
function etaHMS(unix: number | string, options?: ETAOptions): string | null {
    const _options = {
        ignorePast: false,
        nullIfPast: false,
        decimalLimit: 0,
...
function etaYMDHMS(unix: number | string, options?: ETAOptions): string | null {
    const _options = {
        ignorePast: false,
        nullIfPast: false,
        decimalLimit: 0,
 ...
 * @param options An optional object to configure the behavior of the function.
 * @copyright *Code written by **@fujimori_*** */
function etaDigitial(unix: number | string, options?: ETAOptions): string | null {
    const _options = {
        ignorePast: false,
        nullIfPast: false,
        decimalLimit: 0,
